...
-- --------------------------------------------------
-- Date Created: 01/25/2018 12:24:54
-- Generated from EDMX file: D:\freelancer\FreelancerMarketplace\SBSite\Model.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[Profiles] (
    ...
    [IsEnabled] int  NULL,
    [IsTrusted] int  NULL,
    [BitcoinWallet] nvarchar(max)  NULL,
    [EtherWallet] nvarchar(max)  NULL,
    [LiteCoinWallet] nvarchar(max)  NULL,
    [DateCreated] datetime  NULL,
    [DOB] datetime  NULL,
    [ACType] nvarchar(2)  NULL,
    [Gender] nvarchar(8)  NULL,
    [Seeking] nvarchar(8)  NULL,
    [AboutMe] varchar(max)  NULL,
    [IAmSeeking] varchar(max)  NULL,
    [LookingFor] varchar(max)  NULL,
